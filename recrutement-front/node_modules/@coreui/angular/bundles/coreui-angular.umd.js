(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.coreui = global.coreui || {}, global.coreui.angular = {}), global.ng.core, global.ng.common, global.ng.router, global.rxjs, global.rxjs.operators));
    ...
    SidebarToggleDirective.propDecorators = {
        breakpoint: [{ type: i0.Input, args: ['appSidebarToggler',] }],
    ...
    AsideToggleDirective.propDecorators = {
        breakpoint: [{ type: i0.Input, args: ['appAsideMenuToggler',] }],
        toggleOpen: [{ type: i0.HostListener, args: ['click', ['$event'],] }]
    };
    ...
    AppAsideComponent.propDecorators = {
        ...
        fixed: [{ type: i0.Input }],
        offCanvas: [{ type: i0.Input }],
        asideMenuClass: [{ type: i0.HostBinding, args: ['class.aside-menu',] }]
    };
    ...
    var AppBreadcrumbService = /** @class */ (function () {
        function AppBreadcrumbService(router, route) {
            ...
            this.router.events.pipe(operators.filter(function (event) { return event instanceof i1.NavigationEnd; })).subscribe(function (event) {
                var breadcrumbs = [];
    ...
    AppFooterComponent.propDecorators = {
        fixed: [{ type: i0.Input }],
        appFooterClass: [{ type: i0.HostBinding, args: ['class.app-footer',] }]
    };
    ...
    AppHeaderComponent.propDecorators = {
        fixed: [{ type: i0.Input }],
        navbarBrand: [{ type: i0.Input }],
        navbarBrandFull: [{ type: i0.Input }],
        navbarBrandMinimized: [{ type: i0.Input }],
        navbarBrandText: [{ type: i0.Input }],
        navbarBrandHref: [{ type: i0.Input }],
        navbarBrandRouterLink: [{ type: i0.Input }],
        sidebarToggler: [{ type: i0.Input }],
        mobileSidebarToggler: [{ type: i0.Input }],
        asideMenuToggler: [{ type: i0.Input }],
        mobileAsideMenuToggler: [{ type: i0.Input }],
        appHeaderClass: [{ type: i0.HostBinding, args: ['class.app-header',] }],
        navbarClass: [{ type: i0.HostBinding, args: ['class.navbar',] }]
    };
    ...
    var AppSidebarComponent = /** @class */ (function () {
        function AppSidebarComponent(document, renderer, sidebarService) {
             ...
             */
            this.minimizedChange = new i0.EventEmitter();
    ...
    AppSidebarComponent.propDecorators = {
        ...
        minimizedChange: [{ type: i0.Output }],
        sidebarClass: [{ type: i0.HostBinding, args: ['class.sidebar',] }]
    };
    ...
    AppSidebarNavComponent.propDecorators = {
        ...
        sidebarNavClass: [{ type: i0.HostBinding, args: ['class.sidebar-nav',] }],
    ...
    AppSidebarMinimizerComponent.propDecorators = {
        role: [{ type: i0.HostBinding, args: ['attr.role',] }, { type: i0.Input }],
        sidebarMinimizerClass: [{ type: i0.HostBinding, args: ['class.sidebar-minimizer',] }],
        toggleOpen: [{ type: i0.HostListener, args: ['click', ['$event'],] }]
    };
    ...
    AppSidebarFooterComponent.propDecorators = {
        sidebarFooterClass: [{ type: i0.HostBinding, args: ['class.sidebar-footer',] }]
    };
    ...
    AppSidebarFormComponent.propDecorators = {
        sidebarFormClass: [{ type: i0.HostBinding, args: ['class.sidebar-form',] }]
    };
    ...
    AppSidebarHeaderComponent.propDecorators = {
        sidebarHeaderClass: [{ type: i0.HostBinding, args: ['class.sidebar-header',] }]
    };

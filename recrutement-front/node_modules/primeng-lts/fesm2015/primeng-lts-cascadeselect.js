import { forwardRef, EventEmitter, Component, ViewEncapsulation, ChangeDetectionStrategy, Inject, ElementRef, Input, Output, ChangeDetectorRef, ViewChild, ContentChildren, NgModule } from '@angular/core';
...
CascadeSelectSub.ɵfac = function CascadeSelectSub_Factory(t) { return new (t || CascadeSelectSub)(ɵngcc0.ɵɵdirectiveInject(forwardRef(() => CascadeSelect)), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
...
CascadeSelectSub.ctorParameters = () => [
    { type: undefined, decorators: [{ type: Inject, args: [forwardRef(() => CascadeSelect),] }] },
    { type: ElementRef }
];
...
CascadeSelectModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule, SharedModule, RippleModule], SharedModule] });

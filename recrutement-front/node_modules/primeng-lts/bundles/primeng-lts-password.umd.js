(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/animations'), require('@angular/forms'), require('primeng-lts/dom'), require('primeng-lts/api'), require('primeng-lts/inputtext')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/password', ['exports', '@angular/core', '@angular/common', '@angular/animations', '@angular/forms', 'primeng-lts/dom', 'primeng-lts/api', 'primeng-lts/inputtext'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].password = {}), global.ng.core, global.ng.common, global.ng.animations, global.ng.forms, global['primeng-lts'].dom, global['primeng-lts'].api, global['primeng-lts'].inputtext));
    ...
    PasswordModule.decorators = [
        { type: core.NgModule, args: [{
                    ...
                    exports: [PasswordDirective, Password, api.SharedModule],
